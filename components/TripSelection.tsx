...
const enrichTripData = (trip: any): Trip => {
  ...
  } else if (normalizedName.includes('foz') || normalizedName.includes('iguaçu')) {
    image = 'https://images.unsplash.com/photo-1542385151-efd9000785a0?q=80&w=1000&auto=format&fit=crop';
    lat = -25.6953;
    lon = -54.4367;
    isDomestic = false;
    if (!price) price = '$1,300';
  } else if (normalizedName.includes('áfrica do sul') || normalizedName.includes('africa do sul')) {
...
const ANDRE_MARCELLY_TRIPS: Trip[] = [
  ...
  // --- OPÇÕES JULHO ---
  {
    ...
    subtitle: 'Beaches',
    date: 'Julho de 2026',
    image: 'https://images.unsplash.com/photo-1614264627931-155452fc38ab?q=80&w=800&auto=format&fit=crop',
    lat: -16.4497,
    lon: -39.0660,
    userId: 'shared_andre_marcelly',
    isDomestic: true,
  ...
  {
    id: 'am_sp_ssa_aju',
    name: 'São Paulo + Salvador + Aracajú + Catais',
    subtitle: 'Aracajú + Citais',
    date: 'Julho de 2026',
    image: 'https://images.unsplash.com/photo-1543333995-a78ee3e5f947?q=80&w=800&auto=format&fit=crop',
    lat: -23.5505,
    lon: -46.6333,
    userId: 'shared_andre_marcelly',
    isDomestic: true,
  ...
  {
    id: 'am_ssa_aju',
    name: 'Salvador + Aracajú',
    subtitle: 'Pelourinho',
    date: 'Julho de 2026',
    image: 'https://images.unsplash.com/photo-1599388316239-01f280b27ac8?q=80&w=800&auto=format&fit=crop',
    lat: -12.9714,
    lon: -38.5014,
    userId: 'shared_andre_marcelly',
    isDomestic: true,
  ...
  {
    id: 'am_foz_ba',
    name: 'Foz do Iguaçu + Buenos Aires',
    date: 'Janeiro de 2027',
  ...
  },
  {
    ...
    name: 'Foz do Iguaçu + Buenos Aires + Patagônia',
    date: 'Janeiro de 2027',
    image: 'https://images.unsplash.com/photo-1517236327043-fbf36304fd4d?q=80&w=800&auto=format&fit=crop',
    lat: -50.4965,
    lon: -73.0379,
    userId: 'shared_andre_marcelly',
    isDomestic: false,
  ...
  {
    id: 'am_foz_ass_ba',
    name: 'Foz do Iguaçu + Assunção + Buenos Aires',
    date: 'Janeiro de 2027',
  ...
  },
  {
    ...
    name: 'Colômbia',
    date: 'Janeiro de 2027',
    image: 'https://images.unsplash.com/photo-1583531172005-814191b8b6c0?q=80&w=800&auto=format&fit=crop',
    lat: 10.3910,
    lon: -75.4794,
    userId: 'shared_andre_marcelly',
    isDomestic: false,
    ...
    return (
      ...
      >
        <img 
          ...
          className="absolute inset-0 w-full h-full object-cover group-hover:scale-108 transition-transform duration-[1200ms]"
        />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 items-start">
              ...
              <div className="lg:col-span-3 space-y-8">
                <div className="flex items-center gap-2 bg-white/5 border border-white/5 px-4 py-2 rounded-full w-fit shadow-inner">
                  <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
                  <h2 className="text-[10px] font-black text-white uppercase tracking-[0.2em]">
                    OPÇÕES: JANEIRO DE 2027
                  </h2>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {jan2027Trips.map(trip => renderFrostedCard(trip, 'small'))}
                </div>
              </div>
